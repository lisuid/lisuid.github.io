...
title: Butterfly日记
abbrlink: 10b461c
date: 2023-07-14 02:37:37
tags: hexo
cover: https://s3.qjqq.cn/3/64d883ff18f13.webp!color
categories:
 - hexo
 - butterfly
swiper_index: 7
---
# 我的_config.butterfly.yml
```Markdown
...
menu:
   ...
   清单||fas fa-list||hide:
     ...
     照片: /movies/ || fas fa-video
   友链: /link/ || fas fa-link
   关于: /about/ || fas fa-heart
   留言板: /comments/ || fas fa-heart-open
...
social:
  ...
  # fas fa-envelope: mailto:wangshengjie0511@gmail.com || Email || '#4a7dbe'
...
# Avatar (頭像)
avatar:
  img: /img/Cache_-22418fbb8614d0a7.(1).jpg
  effect: false
...
runtimeshow:
  enable: true
  publish_date: 2023/6/12/ 00:00:00
...
# The formal of image: 
background: url(https://pic.imgdb.cn/item/64b2586d1ddac507cc56824b.webp)
# Footer Background
...
inject:
  head:
      ...
      - <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/js-heo@1.0.11/mainColor/heoMainColor.css"> #古诗词
      - <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/js-heo@1.0.11/poem/poem.css"> #古诗词卡片
      - <link rel="stylesheet" type="text/css" href="/css/icat.css">
  ...
  bottom:
      ...
      # 音乐播放器
      - <div class="aplayer no-destroy" data-id="7621851434" data-server="netease" data-type="playlist" data-fixed="true" data-autoplay="true" data-lrcType="-1"> </div>
      - <canvas id="universe"></canvas>
      - <script defer type="text/javascript" src="/js/universe.js"></script>
      - <script async data-pjax type="text/javascript" src="/js/icat.js"></script>
      - <script async type="text/javascript" src="/js/fps.js"></script> # 帧率检测
      - <script type="text/javascript" src="https://unpkg.zhimg.com/jquery@latest/dist/jquery.min.js"></script> # 腾讯地图定位 - 定制化JS
      - <script async data-pjax type="text/javascript" src="/js/txmap.js"></script> # 腾讯地图定位 - API
      ...
      - <script defer type="text/javascript" src="/js/lunar.js"></script> # 农历计算
      - <script defer type="text/javascript" src="/js/day.js"></script> # 节日弹窗
...
electric_clock:
  ...
  qweather_key: c8fea6e064934338bcb946e6e11acb13  # 和风天气key
  gaud_map_key: 2311c722c721552e11ca8596e5707f44 # 高得地图web服务key
...
language: zh-CN
timezone: 
email: 3238355213@qq.com

# URL
## Set your site url here. For example, if you use GitHub Page, set url as 'https://username.github.io/project'
url: http://blog.lisui.top
...
deploy:
  type: git
  repo: 
    github: git@github.com:lisuid/lisuid.github.io.git
    gitee:  git@gitee.com:light-starry-sand/qin.git
  branch: main
  message: upload
...
footer_beautify:
  ...
  # 徽标部分配置项
  swiperpara: 7 #若非0，则开启轮播功能，每行徽标个数
  bdageitem:
